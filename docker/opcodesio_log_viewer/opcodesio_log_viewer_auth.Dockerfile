...
RUN composer create-project laravel/laravel:13.9.0 opcodesio_log_viewer
WORKDIR opcodesio_log_viewer

# Authorization
RUN composer require laravel/breeze:2.4.1 --dev

RUN composer require opcodesio/log-viewer:3.24.0
